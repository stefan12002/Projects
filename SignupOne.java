...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        JLabel formo=new JLabel("APPLICATION FROM NO."+random);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if(name.equals("")){
                ...
                Conn c=new Conn();
                String query="insert into signup values('"+formno+"','"+name+"','"+formno+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pin+"','"+state+"')";
